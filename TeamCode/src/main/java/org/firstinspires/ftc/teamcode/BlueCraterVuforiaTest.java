...
//@Autonomous(name="BlueCraterVuforiaTest", group="Autonomous")

public class BlueCraterVuforiaTest extends LinearOpMode {
...
*/
        ...
        Depot.drive(telemetry, hardwareMap, false, true,this);
        //RB.GoForward(6);
        //RB.GoLeft(17);
        //RB.TurnRight(45);
        //RB.GoLeft(24);
