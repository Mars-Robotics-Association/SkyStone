...
public class buildingZoneSingleMirror extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //***Corner 1***
        nav.NavigateToLocation(-24, 48, 180);//Go to a location
        while (nav.isNavigating){LoopObjects(attachments);}//Loop the various objects in the OpMode
        nav.StopMoving();//stop when done

        //***Corner 2***
        nav.NavigateToLocation(-60, 48, 180);//Go to a location
        while (nav.isNavigating){LoopObjects(attachments);}//Loop the various objects in the OpMode
        nav.StopMoving();//stop when done

        //***Corner 3***
        nav.NavigateToLocation(-60, 0, -90);//Go to a location
        while (nav.isNavigating){LoopObjects(attachments);}//Loop the various objects in the OpMode
        nav.StopMoving();//stop when done
