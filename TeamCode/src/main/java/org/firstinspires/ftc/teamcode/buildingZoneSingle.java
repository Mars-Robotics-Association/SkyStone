...
@Autonomous(name = "buildingZoneSingle", group = "Autonomous")
public class buildingZoneSingle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //***Corner 1***
        nav.NavigateToLocation(23, 48, 0);//Go to a location
